...
class SecurityTaskForceAdapter:
    """Boundary without repository, gateway, or sandbox handles."""
    ...
    async def compile_intent(
        ...
        raise NotImplementedError("Mission Compiler must supply a valid contract")
    ...
    async def submit_creator_approval(
        self,
        creator: Actor,
        action_id: str,
        decision: str,
